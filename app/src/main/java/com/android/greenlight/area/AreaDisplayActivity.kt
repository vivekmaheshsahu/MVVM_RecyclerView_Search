...
import java.util.*
import com.android.greenlight.employee.EmployeeDisplayActivity

class AreaDisplayActivity :IAreaDisplayView, AppCompatActivity() {

    var presenter: IAreaDisplayPresenter<*>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = AreaDisplayPresenter()
        (presenter as AreaDisplayPresenter).attachView(this)
        ...
        if (adapter == null) {
            adapter = AreaDisplayAdapter(getContext(), mWomenList, formId,object : AreaDisplayAdapter.OnItemClickListener{
                override fun onItemClick(uniqueId: String, name: String, form_id: String) {
                    val intent = Intent(this@AreaDisplayActivity, EmployeeDisplayActivity::class.java)
