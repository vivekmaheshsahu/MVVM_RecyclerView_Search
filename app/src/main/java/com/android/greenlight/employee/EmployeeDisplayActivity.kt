...
class EmployeeDisplayActivity :IEmployeeDisplayView, AppCompatActivity(), SearchView.OnQueryTextListener {

    var presenter: IEmployeeDisplayPresenter<*>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = EmployeeDisplayPresenter()
        (presenter as EmployeeDisplayPresenter).attachView(this)
